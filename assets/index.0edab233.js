import{s as n,R as e,W as p,r as u,a as h}from"./vendor.3fac83f1.js";const x=function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))r(a);new MutationObserver(a=>{for(const l of a)if(l.type==="childList")for(const s of l.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function i(a){const l={};return a.integrity&&(l.integrity=a.integrity),a.referrerpolicy&&(l.referrerPolicy=a.referrerpolicy),a.crossorigin==="use-credentials"?l.credentials="include":a.crossorigin==="anonymous"?l.credentials="omit":l.credentials="same-origin",l}function r(a){if(a.ep)return;a.ep=!0;const l=i(a);fetch(a.href,l)}};x();const f=n.header`
    display:flex;
...
`;var D=[{id:1,img:"../public/icon-online.svg",title:"Online Banking",text:"  Our modern web and mobile applications allow you to keep track of your finances wherever you are in the world."},{id:2,img:"../public/icon-budgeting.svg",title:"Simple Budgeting",text:"  See exactly where your money goes each month. Receive notifications when you\u2019re close to hitting your limits."},{id:3,img:"../public/icon-onboarding.svg",title:"Fast Onboarding",text:"We don\u2019t do branches. Open your account in minutes online and start taking control of your finances right away."},{id:4,img:"../public/icon-api.svg",title:"Open API",text:"  Manage your savings, investments, pension, and much more from one account. Tracking your money has never been easier."}],S=[{id:1,img:"../public/image-currency.jpg",author:"By Claire Robinson",title:"Receive money in any currency with no fees",text:"  The world is getting smaller and we\u2019re becoming more mobile. So why should you be forced to only receive money in a single \u2026"},{id:2,img:"../public/image-restaurant.jpg",author:"By Wilson Hutton",title:"Treat yourself without worrying about money",text:"  Our simple budgeting feature allows you to separate out your spending and set realistic limits each month. That means you \u2026"},{id:3,img:"../public/image-plane.jpg",author:"By Wilson Hutton",title:"Take your Easybank card wherever you go",text:"  We want you to enjoy your travels. This is why we don\u2019t charge any fees on purchases while you\u2019re abroad. We\u2019ll even show you \u2026"},{id:4,img:"../public/image-confetti.jpg",author:"By Claire Robinson",title:"Our invite-only Beta accounts are now live!",text:"  After a lot of hard work by the whole team, we\u2019re excited to launch our closed beta. It\u2019s easy to request an invite through the site ..."}];const V=()=>e.createElement(B,null,e.createElement(L,null,e.createElement(I,null,e.createElement(F,{src:k,alt:""})),e.createElement(A,null,e.createElement(M,null,"Next generation digital banking"),e.createElement("p",null,"Take your financial life online. Your Easybank account will be a one-stop-shop for spending, saving, budgeting, investing, and much more."),e.createElement(m,null,"Request Invite"))),e.createElement(R,null,e.createElement(g,null,"Why choose Easybank?"),e.createElement("p",null,"  We leverage Open Banking to turn your bank account into your financial hub. Control your finances like never before."),e.createElement(H,null,D.map(({id:t,img:o,title:i,text:r})=>e.createElement(O,{key:t},e.createElement("img",{src:o,alt:""}),e.createElement("h3",null,i),e.createElement("p",null,r))))),e.createElement(g,null," Latest Articles"),e.createElement(T,null,S.map(({id:t,author:o,img:i,text:r,title:a})=>e.createElement(j,{key:t},e.createElement("img",{src:i,alt:""}),e.createElement("div",null,e.createElement("p",null,o),e.createElement("h3",null,a),e.createElement("p",null,r)))))),$=n.footer`
